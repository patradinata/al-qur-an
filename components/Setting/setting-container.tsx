...
export default function SettingContainer() {
  ...
  return <div className="p-2 w-full max-h-96 overflow-y-scroll">
    ...
    <div className="flex relative rounded-full bg-slate-100 dark:bg-pri-color-dark text-sm p-2">
      <div className={`bg-white dark:bg-sec-color-dark h-9 w-[45%] absolute z[-1] rounded-full drop-shadow-md transition duration-300 ease-in-out ${setting.theme && "translate-x-[100%]"}`}></div>
      ...
      <button onClick={() => setSetting(e => { e.theme = 2; return e})}>Sephia</button>
