  ...
  return (
    <div className="text-sm sm:text-base p-5 m-auto md:w-11/12 sm:flex sm:gap-32 mb-12 dark:border-zinc-300 border-t-2">
      <div className="flex-1 mb-10">
        <h1 className="text-xl uppercase font-semibold">al-qur'an</h1>
        ...
        <div className="flex bg-sephia-color w-full mx-auto rounded-lg justify-center md:justify-start items-center gap-8  my-2 dark:bg-sec-color-light px-2 py-2">
