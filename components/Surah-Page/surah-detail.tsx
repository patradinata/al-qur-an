...
export default function SurahDetailButton() {
  ...
  return (
    <>
      ...
      <div
        ref={infoRef}
        className={`text-white p-8 z-[1] absolute rounded-xl left-0 right-0 text-justify bg-gradient-to-br from-sec-color-light to-thr-color-light transition-all duration-1000 ease-in-out text-sm sm:text-base ${
