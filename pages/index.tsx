...
import { faChevronUp, faChevronDown, faL } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      ...
      <div className="p-5 m-auto md:w-10/12 md:mt-4">
        ...
        <div>
          ...
          <div className="grid gap-4 mt-2 grid-cols-1 lg:grid-cols-3 md:grid-cols-2">{data ? data.map((e) => <SurahCard key={e.surah_number} surahInfo={e} />) : numbers.map((e) => <SurahCardSkeleton key={e} />)}</div>
        </div>
      </div>
    </>
  );
